...
window.addEventListener('scroll', skrollHeader)
...
const scrollUp = () => {
   ...
   // when the scroll is higher than 350 viewport height, add the shoe-scroll class to the a tag with scrollup
   this.scrollY >= 350 ? scrollUp.classList.add('show-scroll') : scrollUp.classList.remove('show-scroll')
}
window.addEventListener('scroll', scrollUp)

/*=============== SCROLL REVEAL ANIMATION ===============*/
// Ensure that ScrollReveal is properly loaded
document.addEventListener('DOMContentLoaded', function () {
   const sr = ScrollReveal({
      origin: 'top',
      distance: '60px',
      duration: 2500,
      delay: 400,  // Fixed typo in 'delay'
